...
public class HostelDAO {
    ...
    public void updateStudent(Student s) throws SQLException {
        String sql = "UPDATE HostelStudents SET StudentName=?, RoomNumber=?, FeesPaid=?, PendingFees=? WHERE StudentID=?";
        try (Connection con = getConnection(); PreparedStatement ps = con.prepareStatement(sql)) {
    ...
    public List<Student> getStudentsByCriteria(String hostelName, String roomNumber) throws SQLException {
        ...
        String sql = "SELECT * FROM HostelStudents WHERE HostelName = ? AND RoomNumber = ?";
